...
SnapOTA-MainPage.py:
    ...
    page to a text file for easy formatting into a reddit post. You will need to head to marvelsnap.com/news to get the page 
    url.

SnapOTA.py:

    is similar to the main page except it requires the cloudfront URL and retrieves the full body and parses that for the 
    notes, same output as above. The cloudfront url is the one that you will get if you click on the OTA or Patch notes 
