...
SnapCard.py grabs a card from snap.fan and provides the ability, card cost and power.
...
SnapOTA is similar to the main page except it requires the cloudfront URL and retrieves the full body and prases that for the notes, same output as above.  
